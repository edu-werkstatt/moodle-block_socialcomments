...
class block_socialcomments_comments_testcase extends advanced_testcase {
    ...
    public function test_post_actions() {
        ...
        $teacherscomment = $DB->get_record('block_socialcomments_comments', array('userid' => $teacher->id));
        ...
        $commenupdated = $DB->get_record('block_socialcomments_comments', array('userid' => $teacher->id));
        ...
        // Try update.
        $result = external_api::call_external_function('block_socialcomments_save_comment', $params);
        $commentupdated = $DB->get_record('block_socialcomments_comments', array('id' => $teacherscomment->id));
        ...
        $commentdeleted = $DB->get_record('block_socialcomments_comments', array('id' => $teacherscomment->id));
        $this->assertNotFalse($commentdeleted);

        // Try to delete own comment.
        $student1comment = $DB->get_record('block_socialcomments_comments', array('userid' => $student1->id));
        $params = array('commentid' => $student1comment->id);
        $result = external_api::call_external_function('block_socialcomments_delete_comment', $params);
        $commentdeleted = $DB->get_record('block_socialcomments_comments', array('id' => $student1comment->id));
    ...
    public function test_external_functions() {
        ...
        $subscribed = $DB->get_record('block_socialcomments_subscripts', $params);
