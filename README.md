...
The plugin is released under [GNU GPL v3 or later](http://www.gnu.org/copyleft/gpl.html). It has been tested and is running on Moodle version 3.8 an 3.9. 
...
How to install Moodle plugins is described here: https://docs.moodle.org/39/en/Installing_plugins#Installing_a_plugin 
